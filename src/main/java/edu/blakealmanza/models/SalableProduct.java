...
public abstract class SalableProduct implements Comparable<SalableProduct> {
  ...
  /**
   * Constructor for the SalableProduct class.
   *
   * @param id                the ID of the product
   * @param name              the name of the product
   * @param description       the description of the product
   * @param dateOfManufacture the date of manufacture of the product
   * @param price             the price of the product
   */
  public SalableProduct(String name, String description, LocalDate dateOfManufacture, double price) {
    this.name = name;
